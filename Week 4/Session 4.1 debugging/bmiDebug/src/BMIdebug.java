...
public class BMIdebug {
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            double bmi = calculateBMI(weightPounds, heightInches); //Originally called heightInches first
            //Print users BMI
            System.out.println("Your BMI is: " + Math.round(bmi)); //Missing space after :
        }
    }
